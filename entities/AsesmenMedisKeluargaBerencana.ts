...
@Index("asesmen_medis_keluarga_berencana_pkey", ["uid"], { unique: true })
@Entity("asesmen_medis_keluarga_berencana", { schema: "public" })
export class AsesmenMedisKeluargaBerencana {
